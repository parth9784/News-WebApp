        ...
        <div className="flex justify-between items-center bg-[#f3faff] pops shadow-md mt-3 fixed top-[0] left-[0] right-[0] ">
            ...
            <div className="relative h-11 w-full min-w-[200px]">
                 <input placeholder="eg. Technology"
                        className="peer h-full w-[150px] border-b border-blue-gray-200 bg-transparent pt-4 pb-1.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border-blue-gray-200 focus:border-gray-900 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50" />
                    <label
